...
ob110462_dir = '/u/jlu/work/microlens/OB110462/a_2020_01_22/model_fits/102_fit_phot_parallax/'
ob110310_dir = '/u/jlu/work/microlens/OB110310/a_2020_01_22/model_fits/102_fit_phot_parallax/'
ob110037_dir = '/u/jlu/work/microlens/OB110037/a_2020_01_22/model_fits/102_fit_phot_parallax/'
...
def piE_tE_phot_only_fits():
    ...
    fitter_110462 = model_fitter.PSPL_Solver(data_110462,
                                             ...
                                             outputfiles_basename = ob110462_dir + 'a0_')
    ...
    fitter_110310 = model_fitter.PSPL_Solver(data_110310,
                                             model.PSPL_Phot_Par_Param1,
                                             outputfiles_basename = ob110310_dir + 'a0_')
    ...
    fitter_110037 = model_fitter.PSPL_Solver(data_110037,
                                             model.PSPL_Phot_Par_Param1,
                                             outputfiles_basename = ob110037_dir + 'a0_')
    ...
    model_fitter.contour2d_alpha(tE_110037, piE_110037, span=[span, span], quantiles_2d=quantiles_2d,
                                 ...
                                 **hist2d_kwargs, plot_density=False)
    axes.text(150, 0.2, 'OB110462', color='purple')    
    axes.text(30, 0.4, 'OB110310', color='red')    
    axes.text(150, 0.35, 'OB110037', color='darkorange')    
