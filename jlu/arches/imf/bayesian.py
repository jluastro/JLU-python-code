...
from jlu.arches import synthetic
...
def make_observed_isochrone(logAge, filterName=defaultFilter,
                            ...
                            iso_dir='/g/lu/models/iso/arches/'):
    startTime = time.time()
    ...
    filt = synthetic.get_filter_info(filterName)
    flux0 = filt.flux0
    mag0 = filt.mag0
    ...
    for ii in range(len(temp)):
        ...
        # ----------
        mag[ii] = synthetic.mag_in_filter(star, filt, red)
