            ...
            while (arGood == False):
                ...
                if (zfrom == 'acc'):
                    ...
                    if (zz == 0):
                        ...
                        print 'Sample from uniform acceleration between the 5 sigma lower limit and amax'

                    # This case essentially ignores amin, since we have tighter constraints
                    # using the 4 sigma lower limit on the acceleration
...
class Disk(object):
    ...
    def run(self, makeplot=False, do_all=True, do_radial_bins=False,
            ...
            do_r1=False, do_r2=False, do_r3=False, simFlat=False):
        ...
        iAll, oAll, r2d = self.loadStars(simFlat=simFlat, return_r2d=True)
    ...
    def densityPDF(self, iAll, oAll, neighbors=[4,5,6,7], aperture=True,
                   sampleWR=None):
        """
        Map out the PDF for the density of normal vectors
        """
...
class IsotropicMC(object):
    def __init__(self, ntrials, pdftrials):
        ...
        mscDir = '/u/syelda/research/gc/aligndir/11_09_12_dp_msc/'
...
def plane2z(x, y, idisk=131.0, odisk=97.0):
    """
