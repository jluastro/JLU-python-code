...
root_dir = '/u/nijaid/work/OB150029/a_2017_08_28/'

an_dir1 = root_dir + 'a_ob150029_2017_08_28_a3_m20_w3_MC100/'
an_dir2 = root_dir + 'a_ob150029_2017_08_28_a4_m20_w3_MC100/'

an_dir = an_dir1
points_dir = an_dir + 'points_d/'
poly_dir = an_dir + 'polyfit_d/'

targets = ['OB150029', 'S11_15_3.9', 'S12_15_2.5', 'S14_15_2.2']
...
def apply_local_astrometry(an_dir):
    ...
    for ee in range(N_epochs):
        ...
        # Print the deltas specifically for OB150029
        lens = np.where(np.array(name) == 'OB150029')[0][0]
...
def plot_three_stars():
    starNames = ['ob150029', 'S11_15_3.9', 'S12_15_2.5', 'S14_15_2.2']

    residuals.plotStar(starNames, rootDir=an_dir2, align='align/align_t',
