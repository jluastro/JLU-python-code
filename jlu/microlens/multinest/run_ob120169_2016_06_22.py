...
##########
target = 'ob120169'
rootdir = '/Users/jlu/work/microlens/OB120169/analysis_2016_06_22/'
pointsdir = 'points_d/' 
mcmcPhotDir = 'photometry/posteriors/'

# O=2, Kcut=22, u0-
analysisdir = 'analysis_ob120169_2016_06_22_a4_m22_w4_MC100/'
mcmcPhotFile = 'ob120169_mcmc_u0minus.dat'
photPriorsSuffix = '_u0minus'
runcode = 'um'

# O=2, Kcut=22, u0+
# analysisdir = 'analysis_ob120169_2016_06_22_a4_m22_w4_MC100/'
# mcmcPhotFile = 'ob120169_mcmc_u0plus.dat'
# photPriorsSuffix = '_u0plus'
# runcode = 'up'
...
if MultiDimPriors == True:
    PhotPriorsFile = 'PhotPriors_MultiDim_' + target + photPriorsSuffix + '.txt'
else:
    PhotPriorsFile = 'PhotPriors_' + target + photPriorsSuffix + '.txt'
...
print 'run_ob120169: Read in Astrometric Data'
if target == 'ob120169':
...
print 'run_ob120169: Set Origin of Coord Sys'
orig_x_pix, orig_y_pix  = np.mean(xpix), np.mean(ypix)
print 'run_ob120169:     ', orig_x_pix, orig_y_pix
...
print 'run_ob120169: Make Random Number Generators'
...
def MultiDimPrior_Gen(intable):
    Nrows = intable.shape[0]
    Ncols = intable.shape[1]
...
def GenPhotPriors():
    ...
    if MultiDimPriors == True:
        ...
        savearr = np.loadtxt(photpriors_saveto + PhotPriorsFile)
        bins = np.loadtxt(photpriors_saveto + PhotPriorsFile[0:-4] + '_bins.txt')
        Photpars['MultiDimPrior_Bins'] = bins
        Photpars['MultiDimPrior'] = savearr
...
print 'run_ob120169: Get Photometric Prior Distributions'
...
def multinest_run(n_live_points=1000, 
                  target = 'ob120169', saveto=multiNest_saveto):
