...
root_dir = '/u/nijaid/work/OB150211/a_2017_08_28/'

an_dir1 = root_dir + 'a_ob150211_2017_08_28_a3_m20_w3_MC100/'
an_dir2 = root_dir + 'a_ob150211_2017_08_28_a4_m20_w3_MC100/'
...
def apply_local_astrometry(an_dir):
    ...
    for ee in range(N_epochs):
        ...
        # Fetch the positions for the two nearby bright sources of interest
        idx1 = np.nonzero(np.in1d(name, targets))[0]
        ...
        # Print the deltas specifically for OB150211
        lens = np.where(np.array(name) == 'OB150211')[0][0]
...
def plot_three_stars_old_new(targets, years, x_old, y_old, xe_old, ye_old, x_new, y_new, xe_new, ye_new, outsuffix=''):
    ...
    dateTicRng = [2015, 2018]
    dateTics = np.arange(2015, 2019)
...
def plot_three_stars(targets=targets):
    # starNames = ['ob150211', 'psf_001', 'psf_002', 'psf_003', 'psf_004']

    residuals.plotStar(targets, rootDir=an_dir2, align='align/align_t',
