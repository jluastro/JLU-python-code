...
def multinest_pspl_parallax(data, n_live_points=1000,
                            saveto='./mnest_pspl/', runcode='aa'):
...
def load_mnest_results(mnest_dir, mnest_root):
    ...
    tab.rename_column('col5', 'xS0_E')
    tab.rename_column('col6', 'xS0_N')
    tab.rename_column('col7', 'beta')
    tab.rename_column('col8', 'muL_E')
    tab.rename_column('col9', 'muL_N')
    tab.rename_column('col10', 'muS_E')
    tab.rename_column('col11', 'muS_N')
    tab.rename_column('col12', 'dL')
    tab.rename_column('col13', 'dLdS')
    tab.rename_column('col14', 'imag_base')
    tab.rename_column('col15', 'dS')

    if len(tab.columns) > 16:
        tab.rename_column('col16', 'tE')
        tab.rename_column('col17', 'thetaE')
        tab.rename_column('col18', 'piE_E')
        tab.rename_column('col19', 'piE_N')
        tab.rename_column('col20', 'u0_amp')
        tab.rename_column('col21', 'muRel_E')
        tab.rename_column('col22', 'muRel_N')
