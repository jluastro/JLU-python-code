...
# USER INPUT
target = 'ob120169'
rootdir = '/Users/jlu/work/microlens/OB120169/analysis_2015_09_18/'
pointsdir = 'points_d/' 
mcmcPhotDir = 'photometry/posteriors/'
# runcode = 'ay'
# mcmcPhotFile = 'ob120169_mcmc_u0plus.dat' 
runcode = 'ax'
mcmcPhotFile = 'ob120169_mcmc_u0minus.dat' 
...
target = target.lower()
# Access appropriate data directories
if target == 'ob110022':
	analysisdir = 'analysis_ob110022_2014_03_22ah_MC100_omit_1/'   
elif target == 'ob110125':
	analysisdir='analysis_ob110125_2014_03_22al_MC100_omit_1/'
elif target == 'ob120169':
	analysisdir='analysis_ob120169_2015_09_18_a3_m20_w4_MC100/'
else:
...
print 'Read in Astrometric Data'
if target == 'ob120169':
...
print 'Set Origin of Coord Sys'
orig_x_pix, orig_y_pix  = np.mean(xpix), np.mean(ypix)
print '    ', orig_x_pix, orig_y_pix
...
print 'Make Random Number Generators'
...
def MultiDimPrior_Gen(intable):
    ...
    ## bininds=[]     
    ## for i in range(len(pdfflat)):
    ##     curr=[]
    #pdb.set_trace()
    ##     for j in range(Ncols): curr.append(np.where(temp==i)[j])
    ##     bininds.append(curr)
    ...
    return bins, savearr  # bins = bin edges, savearr columns are normalized pdf, cdf, index[0], index[1], index[2]... where indices are multi-dimensional bin indices
...
#         py.plot((bins[0:Nbins-1]+bins[1:Nbins])/2., temppdf)
#   
#         py.savefig(rootdir + analysisdir +'plots/temp1_'+parnames[i]+'.pdf')
#         py.clf()
	    
	    	     
	# Turn MCMC chains into probability density functions (pdf)	
...
print 'Get Photometric Prior Distributions'
