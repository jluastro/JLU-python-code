...
sky_annulus_start = {'h': 170, 'kp': 200, 'k': 200}
sky_annulus_width = {'h': 50, 'kp': 50, 'k': 50}
standard_aperture = {'h': 150, 'kp': 150, 'k': 150}
...
def all_test_sky():
    ...
    for star in stars:
        for filt in filters:
            ...
            test_sky(star + '_' + filt)

def all_plot_test_sky():
    stars = ['fs140', 'fs144', 'fs148']
    filters = ['kp', 'k', 'h']
    ...
    for star in stars:
        for filt in filters:
            ...
            print 'Plotting ' + star + '_' + filt
            plot_test_sky(star + '_' + filt)
